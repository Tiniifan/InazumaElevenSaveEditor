...
namespace InazumaElevenSaveEditor.Common.InazumaElevenGo
{
    public static class Avatars
    {
        public static IDictionary<UInt32, Avatar> Go = new Dictionary<UInt32, Avatar>
        {
            ...
            {0xC614FB62, new Avatar("Leon", true) },
            {0x570944F2, new Avatar("Chione", true) },
            {0xC1394385, new Avatar("Scramjet", true) },
            {0x24B084E5, new Avatar("Surtr", true) },
            {0xB2808392, new Avatar("Gigante", true) },
            {0x08D18A0B, new Avatar("Thunderbird", true) },
            {0x9EE18D7C, new Avatar("Poseidon", true) },
            {0x3D74E9E2, new Avatar("Trickster", true) },
            {0xAB44EE95, new Avatar("Phantasma", true) },
            {0x1115E70C, new Avatar("Goliath", true) },
            {0x8725E07B, new Avatar("Lot", true) },
            {0x16385FEB, new Avatar("White Pawn", true) },
            {0x8008589C, new Avatar("White Knight", true) },
            {0xE7E3A9CE, new Avatar("White Bishop", true) },
            {0x71D3AEB9, new Avatar("White Rook", true) },
            ...
            {0x4476CD50, new Avatar("Trigger", true) },
            {0xD56B72C0, new Avatar("Black Butcher", true) },
            {0x435B75B7, new Avatar("White Wyvern", true) },
            {0x30E2B5A0, new Avatar("Corvus", true) },
            {0x8AB3BC39, new Avatar("Dragoon", true) },
            {0x1C83BB4E, new Avatar("Arch Pegasus", true) },
            {0xBF16DFD0, new Avatar("Black Pawn", true) },
            {0x2926D8A7, new Avatar("Black Knight", true) },
            {0x9377D13E, new Avatar("Black Bishop", true) },
            {0x0547D649, new Avatar("Black Rook", true) },
            {0x945A69D9, new Avatar("Black Queen", true) },
            {0x026A6EAE, new Avatar("Black King", true) },
            {0x6144F398, new Avatar("Firebird", true) },
            {0xF774F4EF, new Avatar("Roc", true) },
            {0x4D25FD76, new Avatar("Berserker", true) },
            {0xDB15FA01, new Avatar("Behemoth", true) },
            {0x78809E9F, new Avatar("Jester", true) },
            ...
            {0xC5FC2FE1, new Avatar("Las Vega", true) },
            {0x2075E881, new Avatar("Koro-koro-Gon", true) },
            {0xB645EFF6, new Avatar("Majin", true) },
            {0x0C14E66F, new Avatar("Serendipity", true) },
        ...
        {
            {0x7516C2DD, new Avatar("Feng-Huang", true) },
            {0x5977CC33, new Avatar("Athene", true) },
            {0xFAE2A8AD, new Avatar("Sickle Weasel", true) },
            {0x6CD2AFDA, new Avatar("Brynhildr", true) },
            {0xD683A643, new Avatar("Cychr", true) },
            {0x40B3A134, new Avatar("Xuan-Wu", true) },
            {0xD1AE1EA4, new Avatar("Lycaon", true) },
            {0x479E19D3, new Avatar("Zodiac", true) },
            {0xA217DEB3, new Avatar("Amaterasu", true) },
            {0x3427D9C4, new Avatar("Jagwarrior", true) },
            {0x8E76D05D, new Avatar("Plasma Shadow AT", true) },
            {0x1846D72A, new Avatar("Plasma Shadow DF", true) },
            {0xBBD3B3B4, new Avatar("Plasma Shadow SH", true) },
            {0x2DE3B4C3, new Avatar("Plasma Shadow GK", true) },
            {0x97B2BD5A, new Avatar("Sir Rabby", true) },
            {0x0182BA2D, new Avatar("Atlanticus", true) },
            {0x909F05BD, new Avatar("The Lovers♀", true) },
            ...
            {0xE2FF2C44, new Avatar("The Stationer", true) },
            ...
            {0x8FAF39B3, new Avatar("Ashtaroth", true) },
            {0x1EB28623, new Avatar("The Lovers♂", true) },
            {0x88828154, new Avatar("Arch Pegasus Red", true) },
        };
        ...
        public static IDictionary<UInt32, Avatar> Galaxy = new Dictionary<UInt32, Avatar>(Cs)
        {
            ...
            {0x9C0C0635, new Avatar("Falcon", false) },
            ...
            {0x4B0D1A5B, new Avatar("Peacock", false) },
            {0xDD3D1D2C, new Avatar("Mammoth", false) },
            {0x7EA879B2, new Avatar("Gazelle", false) },
            {0xE8987EC5, new Avatar("Grizzly Bear", false) },
            {0x52C9775C, new Avatar("Ratel", false) },
            ...
            {0x1E6E3007, new Avatar("Mossfii", false) },
            ...
            {0x733E25F0, new Avatar("Grifbang", false) },
            ...
            {0x41B6FEFE, new Avatar("Silver Wolf", false) },
            {0x229863C8, new Avatar("Bald Eagle", false) },
            ...
            {0xAD6C09B8, new Avatar("Black Bear", false) },
            {0x173D0021, new Avatar("Zuuma", false) },
            {0x810D0756, new Avatar("Horned Owl", false) },
            ...
            {0x4FC8763F, new Avatar("Kosfii", false) },

...
namespace InazumaElevenSaveEditor.InazumaEleven.INZ
{
    public class INZ6 : IPlayerFiles
    {
        ...
        private IDictionary<UInt32, Player> Players => Common.GO.Players.Galaxy;

        private IDictionary<UInt32, Move> Moves => Common.GO.Moves.Galaxy;

        private IDictionary<UInt32, Avatar> Avatars => Common.GO.Avatars.Galaxy;

        private IDictionary<UInt32, Equipment> Equipments => Common.GO.Equipments.Galaxy;

        private IList<BestMatch> BestMatchs = Common.GO.BestMatchs.Galaxy;

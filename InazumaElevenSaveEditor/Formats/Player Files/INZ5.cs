...
namespace InazumaElevenSaveEditor.Formats.Player_Files
{
    public class INZ5 : IPlayerFiles
    {
        ...
        private IDictionary<UInt32, Player> Players => Common.InazumaElevenGo.Players.Cs;

        private IDictionary<UInt32, Move> Moves => Common.InazumaElevenGo.Moves.Cs;

        private IDictionary<UInt32, Avatar> Avatars => Common.InazumaElevenGo.Avatars.Cs;

        private IDictionary<UInt32, Equipment> Equipments => Common.InazumaElevenGo.Equipments.Cs;
